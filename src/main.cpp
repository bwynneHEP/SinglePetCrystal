...
int main( int argc, char* argv[] )
{
  ...
  ActionInitialization * actions = new ActionInitialization( sourceName );
  runManager->SetUserInitialization( actions );

  // Set up detector
  DetectorConstruction * detector = new DetectorConstruction( detectorName, outputFileName, detectorMaterial );
